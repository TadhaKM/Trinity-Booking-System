    ...
    <div className="min-h-screen bg-[#EFF2F7] flex" data-testid="login-page">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-[#0A2E6E] via-[#1A6FEF] to-[#59D4C8] items-center justify-center p-12">
        ...
        <div className={`relative z-10 max-w-md transition-all duration-1000 ease-out ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          {/* Logo */}
          <Link href="/" className="flex items-center gap-3 mb-12 group" data-testid="login-logo">
          ...
          <h2 className="text-4xl md:text-5xl font-black text-white tracking-tight leading-tight mb-6 text-balance">
            ...
            <span className="text-gradient-mint">campus life.</span>
          </h2>
          ...
          {/* Campus image card */}
          <div className="relative rounded-2xl overflow-hidden shadow-2xl shadow-black/20 animate-float" style={{ animationDuration: '8s' }}>
            <img
              src="https://cdn.britannica.com/30/242230-050-8A280600/Dublin-Ireland-Trinity-College.jpg"
              alt="Trinity College Dublin"
              className="w-full h-48 object-cover"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-[#0A2E6E]/70 to-transparent" />
            <div className="absolute bottom-4 left-4 right-4">
              <div className="bg-white/15 backdrop-blur-md rounded-xl px-4 py-3 border border-white/10">
                <div className="flex items-center gap-2">
                  <div className="w-2.5 h-2.5 bg-[#59D4C8] rounded-full animate-pulse" />
                  <span className="text-white/90 text-sm font-semibold">Live events happening now</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className={`max-w-md w-full transition-all duration-1000 ease-out ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`} style={{ transitionDelay: '200ms' }}>
          ...
          <div className="bg-white rounded-[1.5rem] shadow-xl shadow-slate-200/50 border border-slate-100 p-8" data-testid="login-form-card">
            ...
            <form onSubmit={handleSubmit} noValidate>
              {/* Email */}
              <div className="mb-5">
                <label htmlFor="email" className="block text-sm font-semibold text-[#0A2E6E] mb-2" data-testid="login-email-label">
                  Email address
                </label>
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-3.5 border border-slate-200 rounded-xl text-[#0A2E6E] placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-[#1A6FEF]/30 focus:border-[#1A6FEF] transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed bg-slate-50/50 hover:bg-white hover:border-slate-300"
                  />
                </div>
              </div>
              ...
              {/* Password */}
              <div className="mb-5">
                <label htmlFor="password" className="block text-sm font-semibold text-[#0A2E6E] mb-2" data-testid="login-password-label">
                  Password
                </label>
                <div className="relative">
                  <div className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-12 py-3.5 border border-slate-200 rounded-xl text-[#0A2E6E] placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-[#1A6FEF]/30 focus:border-[#1A6FEF] transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed bg-slate-50/50 hover:bg-white hover:border-slate-300"
                  />
                  <button
                    type="button"
                    onClick={() => setShowPassword(!showPassword)}
                    data-testid="login-toggle-password"
                    className="absolute right-3.5 top-1/2 -translate-y-1/2 text-slate-400 hover:text-[#1A6FEF] transition-colors p-1 rounded-lg hover:bg-[#1A6FEF]/5"
              ...
              <div className="flex items-center mb-7">
                <input
                  ...
                  className="h-4 w-4 rounded border-slate-300 text-[#1A6FEF] focus:ring-[#1A6FEF] cursor-pointer"
                />
            ...
            <div className="mt-8 pt-6 border-t border-slate-100 text-center">
              <p className="text-sm text-slate-500">
                ...
                <Link href="/signup" data-testid="login-signup-link" className="text-[#1A6FEF] font-semibold hover:text-[#0A2E6E] transition-colors">
                  Create one
                </Link>
              </p>
            </div>
